...
#define speaker 10
const int MaxDistanceTimeout = 28000;
...
void setup(){
  ...
  pinMode(SR04_ECHO_PIN, INPUT);
    ...
    initial_distance = distanceInCm() -10;
    Serial.println("initial distance is"); Serial.println(initial_distance);

    //Timer and Speaker Setup
    TCCR1A = 0x20; //OUTPUT ON OC1B
    TCCR1B = 0x09;
...
void play_HIGHnote(){
  ...
  delay(1500);
  Serial.println("HIGH NOTE PLAYING");
  TCCR1A = 0x10;
  TCCR1B = 0x01;
  delay(50);
  TCCR1A = 0x10;
...
void play_LOWnote(){
  ...
  digitalWrite(speaker, HIGH);
  delay(1500);
  Serial.println("LOW NOTE PLAYING");
  TCCR1A = 0x30;
  TCCR1B = 0x01;
  delay(50);
  TCCR1A = 0x30;
